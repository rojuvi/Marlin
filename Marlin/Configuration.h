...
#define STRING_CONFIG_H_AUTHOR "(BigTreeTech, donkikote)" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "DonkiPrinter A8"
...
#define EXTRUDE_MAXLENGTH 200 // Prev 600 for Ender3 bowden
